...
namespace DSN {
    class VoskSpeechRecognition : NAudio.CoreAudioApi.Interfaces.IMMNotificationClient, ISpeechRecognitionManager {
        ...
        private readonly VoskRecognizer DSN;
        ...
        public VoskSpeechRecognition(Configuration config) {
            this.config = config;
            ...
            this.DSN = new VoskRecognizer(config);
